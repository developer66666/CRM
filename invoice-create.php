...
include('includes/createinvoiceheader.php');
include('functions.php');

?>

		<center><h3>Create New Invoice</h3></center>
		<hr>
		...
		<form method="post" id="create_invoice">
			...
			<div class="row">
				...
				<div class="col-xs-8 text-right">
					<div class="row">
						<div class="col-xs-6">
							<h2 class="invoice_type">Quotation</h2>
						</div>
						<div class="col-xs-3">
							<select name="invoice_type" id="invoice_type" class="form-control">
								<option value="quote" selected>Quotation</option>
							...
							<div class="row">
								...
								<div class="col-xs-6">
									<div class="input-group float-right margin-bottom">
										...
										<input type="text" class="form-control copy-input required" name="customer_email" id="customer_email" placeholder="E-mail address" aria-describedby="sizing-addon1" tabindex="2">
									</div>
								    <div class="form-group">
