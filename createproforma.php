<?php 
session_start();
include('includes/invheader.php');
...
<div class="container content-invoice">
	<form action="createproformavalid.php" id="invoice-form" method="post" class="invoice-form" role="form" novalidate=""> 
		<div class="load-animate animated fadeInUp">
			<div class="row">
				<div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
					 <h2 align="center">Proforma Invoice</h2><br /> 
					<?php include('includes/invmenu.php');?>	
				</div>		    		
			</div>
