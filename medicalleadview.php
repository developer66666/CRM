...
$sql = "SELECT * FROM leadmedical";  
$result = mysqli_query($connect, $sql);
?>
<html>  
 <head>   <meta name="viewport" content="width=device-width, initial-scale=0.86, maximum-scale=3.0, minimum-scale=0.86">
  <title>Medical Leads</title>  
 ...
 <body>  
    ...
    <h2 align="center">Medical Database</h2><br /> 
	
	 <div class="text-left"><form method="post" action="medicalleadviewvalid.php">
