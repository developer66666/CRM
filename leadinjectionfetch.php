...
$columns = array('enquirydate', 'fname', 'company', 'mobile', 'email', 'street', 'city', 'state', 'country', 'gst', 'productname', 'model', 'quantity', 'targetprice', 'description', 'customertype', 'leadsource',  'feedback', 'leadstatus', 'engineer', 'branch');
