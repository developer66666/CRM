...
<html>  
 ...
 <div class="container-fluid">
          ...
          <div class="text-left">
			...
			<h3 align="center">Injection Moulding Leads</a></h3><br />
			<br />
			<br />
...
$(document).ready(function(){ 
	...
	$('#save').click(function(){
		...
		if($('#enquirydate').val() == '')
		{
			error_enquirydate = 'Enquiry Date us required';
		...
		else
		{
			...
			if($('#feedback').val() == '')
		{
			error_feedback = 'Your Feedback is required';
